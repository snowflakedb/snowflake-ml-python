...
class Registry:
    ...
    def log_model(
        ...
        *,
        ...
        Raises:
            ValueError: Raised when trying to have a dot in the version name which is not allowed.
        ...
        # TODO(SNOW-988397): Remove once dot is allowed.
        if "." in version_name:
            raise ValueError("Dot (`.`) is currently not allowed in the version name.")
