...
from snowflake.ml.model import deployer, model as model_api
...
def create_model_registry(
    ...
    Args:
        session (snowpark.Session): Session object to communicate with Snowflake.
        database_name (str): Desired name of the model registry database.
...
def _create_registry_database(
    ...
    Args:
        session (snowpark.Session): Session object to communicate with Snowflake.
        database_name (str): Desired name of the model registry database.
        schema_name (str): Desired name of the schema used by this model registry inside the databse.
        registry_table_name (str): Name for the main model registry table.
        metadata_table_name (str): Name for the metadata table used by the model registry.
...
class ModelRegistry:
    ...
    def _insert_table_entry(self, *, table: str, columns: Dict[str, Any]) -> List[snowpark.Row]:
        ...
        Args:
            ...
            columns (dict): Key-value pairs of columns and values to be inserted into the table.
    ...
    def _insert_registry_entry(self, *, id: str, properties: Dict[str, Any]) -> List[snowpark.Row]:
        ...
        Args:
            id (str): Model id to register.
            properties (dict): Dictionary of properties corresponding to table columns.
    ...
    def _insert_metadata_entry(self, *, id: str, attribute: str, value: Any) -> List[snowpark.Row]:
        ...
        Args:
            id (str): Model id to register.
            attribute (str): name of the metadata attribute
            value (Any): new value of the metadata attribute
    ...
    def _prepare_model_stage(self, *, id: str) -> str:
        ...
        Args:
            id (str): Identifier string of the model intended to be stored in the stage.
    ...
    def _set_metadata_attribute(self, id: str, attribute: str, value: Any) -> None:
        ...
        if number_of_entries_with_id == 0:
    ...
    def set_model_name(self, *, id: str, name: str) -> None:
        ...
        Args:
            id (str): Model ID string.
            name (str): Desired new model name.
        """
    ...
    def set_tag(self, id: str, name: str, value: str) -> None:
        ...
        Args:
            id (str): Model ID string.
            name (str): Desired tag name.
            value (str): (optional) New tag value. If no value is given the value of the tag will be set to None.
        """
    ...
    def has_tag(self, id: str, name: str, value: Optional[str] = None) -> bool:
        ...
        Args:
            id (str): Model ID string.
            name (str): Desired tag name.
            value (str): (optional) Tag value to check. If not value is given, only the presence of the tag will be
                checked.
    ...
    def set_model_description(self, *, id: str, description: str) -> None:
        ...
        Args:
            id (str): Model ID string.
            description (str): Desired new model description.
        """
    ...
    def get_model_history(self, id: str) -> snowpark.DataFrame:
        ...
        Args:
            id (str): Id of the model to retrieve the history for.
    ...
    def log_model(
        ...
        *,
        ...
        Args:
            model (Any): Local model object in a supported format.
            name (str): The given name for the model.
            tags (Dict[str. str]): string-to-string dictonary of tag names and values to be set for the model.
            pip_requirements (List[str]): List of dependencies to include with the model
            sample_input_data (Any): Sample of the input data for the model.
    ...
    def register_model(
        ...
        *,
        ...
        Args:
            id (str): Unique identifier to be used for the model. This is required to be unique within the registry and
                uniqueness will be verified. The model id is immutable once set.
            type (str): Type of the model. Only a subset of types are supported natively.
            uri (str): Resource identifier pointing to the model artifact. There are no restrictions on the URI format,
                however only a limited set of URI schemes is supported natively.
            input_spec (Optional[Dict[str, str]]): The expected input schema of the model. Dictionary where the keys are
                expected column names and the values are the value types.
            output_spec (Optional[Dict[str, str]]): The expected output schema of the model. Dictionary where the keys
                are expected column names and the values are the value types.
            name (str): Name to be set for the model. The model name can be changed after registration and is not
                required to be unique inside the registry. The combination of name and version is expected to be unique
                inside the registry.
            version (str): Version string to be set for the model. The model version string can be changed after model
            ...
            description (Optional[str]): A desription for the model. The description can be changed later.
            tags (Optional[Dict[str, str]]): Key-value pairs of tags to be set for this model. Tags can be modified
    ...
    def log_model_path(
        ...
        Args:
            path (str): Local file path to be uploaded.
            type (str): Type of the model to be added.
            name (str): The given name for the model.
            tags (Dict[str, str]): string-to-string dictonary of tag names and values to be set for the model.
    ...
    def _get_model_path(self, id: str) -> str:
        ...
        Args:
            id (str): Id of the model to deploy.
    ...
    def grant_model(self, id: str, permission: str, role: str) -> None:
        ...
        Args:
            id (str): Model id.
            permission (str): What privileges to grant.
    ...
    def deploy(self, id: str, name: str) -> None:
        ...
        Args:
            id (str): Id of the model to deploy.
            name (str): name of the generated UDF.
