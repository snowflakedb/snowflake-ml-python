...
class LabelEncoder(base.BaseEstimator, base.BaseTransformer):
    def __init__(
        ...
        self.classes_: Optional[snowml_type_utils.LiteralNDArrayType] = None
    ...
    def transform(self, dataset: Union[snowpark.DataFrame, pd.DataFrame]) -> Union[snowpark.DataFrame, pd.DataFrame]:
        ...
        if isinstance(dataset, snowpark.DataFrame):
            ...
            output_df = self._ordinal_encoder.transform(dataset).na.replace(
                typing.cast(snowpark_type_utils.LiteralType, float("nan")),
                typing.cast(snowpark_type_utils.LiteralType, len(self.classes_) - 1),
