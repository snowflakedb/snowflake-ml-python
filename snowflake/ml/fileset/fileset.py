...
class FileSet:
    ...
    def make(
        ...
        *,
        target_stage_loc: str,
        name: str,
        snowpark_dataframe: snowpark.DataFrame | None = None,
        sf_connection: connection.SnowflakeConnection | None = None,
        query: str = "",
        shuffle: bool = False,
    ) -> "FileSet":
        ...
        casted_df = snowpark_dataframe_utils.cast_snowpark_dataframe(snowpark_dataframe)
...
def _get_fileset_query_id_or_raise(files: list[str], fileset_absolute_path: str) -> str | None:
