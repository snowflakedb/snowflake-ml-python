...
class MLRuntimeTransformHandlers:
    def __init__(
        ...
        try:
            ...
            raise e  # TODO - this should probably be a snowflake ml exception.

        self.client = MLRuntimeClient(f"Class: {class_name}, Subproject: {subproject}")  # TODO name this client?
