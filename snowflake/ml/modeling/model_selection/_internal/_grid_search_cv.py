...
class GridSearchCV(BaseTransformer):
    ...
    def _fit_snowpark(self, dataset: DataFrame) -> None:
        ...
        params_to_evaluate = list(ParameterGrid(self._sklearn_object.param_grid))
        ...
        for param_chunk in param_chunks:
            ...
            estimator.param_grid = param_chunk_dist
        ...
        # cachetools package was not included in udtf, error raised.
