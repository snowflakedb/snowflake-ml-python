...
class EnvUtilsTest(absltest.TestCase):
    ...
    def test_get_package_spec_with_supported_ops_only(self) -> None:
        ...
        r = requirements.Requirement("numpy>=1,<3")
        self.assertEqual(env_utils.get_package_spec_with_supported_ops_only(r), requirements.Requirement("numpy>=1,<3"))
...
"""
    ...
    def test_is_local_conda_environment(self) -> None:
        conda_prefix = "/fake/miniconda/envs/myenv"
        with mock.patch.object(sys, "prefix", conda_prefix):
