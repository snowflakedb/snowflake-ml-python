...
class ServiceSQLTest(absltest.TestCase):
    ...
    def test_describe_service(self) -> None:
        """Test describe_service returns the correct row with dns_name and spec."""
        m_statement_params = {"test": "1"}
        service_spec = """
            spec:
            containers:
        ...
        self.assertEqual(res["dns_name"], "my-service.test.e6nv.svc.spcs.internal")
        self.assertEqual(res["spec"], service_spec)
