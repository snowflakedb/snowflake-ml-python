        ...
        *,
        ...
        if service_name:  # service spec
            ...
            service_dict = model_deployment_spec_schema.ServiceDict(
                ...
                **cast(model_deployment_spec_schema.ServiceDict, base_inference_spec),
            )

            # model deployment spec
            model_deployment_spec_dict: Union[
                model_deployment_spec_schema.ModelServiceDeploymentSpecDict,
                model_deployment_spec_schema.ModelJobDeploymentSpecDict,
            ] = model_deployment_spec_schema.ModelServiceDeploymentSpecDict(
                models=[model_dict],
            ...
            job_dict = model_deployment_spec_schema.JobDict(
                name=fq_job_name,
                compute_pool=inference_compute_pool_name.identifier(),
                ...
                **cast(model_deployment_spec_schema.JobDict, base_inference_spec),
            )

            # model deployment spec
            model_deployment_spec_dict = model_deployment_spec_schema.ModelJobDeploymentSpecDict(
                models=[model_dict],
                image_build=image_build_dict,
                job=job_dict,
            )
