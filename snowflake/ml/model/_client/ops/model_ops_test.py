...
from snowflake.snowpark import DataFrame, Session, exceptions as spe, types as spt
...
class ModelOpsTest(absltest.TestCase):
    ...
    def test_prepare_model_stage_path(self) -> None:
        with mock.patch.object(self.m_ops._stage_client, "create_sse_stage",) as mock_create_stage, mock.patch.object(
    ...
    def test_create_from_stage_2(self) -> None:
        ...
        with mock.patch.object(
            ...
            mock_create_from_stage.side_effect = spe.SnowparkSQLException(
                message='002002 (42710): Model TEMP."test".MODEL has existed'
            )
            self.m_ops.create_from_stage(
                composed_model=mock_composer,
                model_name=sql_identifier.SqlIdentifier("MODEL"),
    ...
    def test_create_from_stage_3(self) -> None:
        ...
        with mock.patch.object(
            ...
            mock_create_from_stage.side_effect = spe.SnowparkSQLException(message="351020: Random Incident")
            with self.assertRaises(spe.SnowparkSQLException):
                self.m_ops.create_from_stage(
                    composed_model=mock_composer,
                    model_name=sql_identifier.SqlIdentifier("MODEL"),
                    version_name=sql_identifier.SqlIdentifier("V1"),
