...
class ModelMetadata:
    ...
    def _validate_model_metadata(loaded_meta: Any) -> model_meta_schema.ModelMetadataDict:
        ...
        loaded_meta_version = loaded_meta.get("version", None)
        if not loaded_meta_version or loaded_meta_version != model_meta_schema.MODEL_METADATA_VERSION:
        ...
        # TODO: Try upgrade metadata schema here
