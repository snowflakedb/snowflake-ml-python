...
class TorchScriptHandlerMigrator20250101Test(absltest.TestCase):
    def test_multiple_inputs(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            with model_meta_api.create_model_metadata(
                ...
                migrator_1 = torchscript_migrator_2023_12_01.TorchScriptHandlerMigrator20231201()
                migrator_1.try_upgrade(name="model1", model_meta=meta, model_blobs_dir_path=tmpdir)

                model_blob_meta_options = cast(model_meta_schema.PyTorchModelBlobOptions, meta.models["model1"].options)
