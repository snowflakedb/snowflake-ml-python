...
Additional ML APIs are available in ``snowflake-ml-python``  when running on `Container Runtime for ML <https://docs.snowflake.com/developer-guide/snowflake-ml/container-runtime-ml>`_.
