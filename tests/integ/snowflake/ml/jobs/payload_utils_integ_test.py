...
class PayloadUtilsTests(parameterized.TestCase):
    ...
    @parameterized.parameters(  # type: ignore[misc]
        ...
        (TestAsset("src"), TestAsset("main.py", resolve_path=False), "/mnt/job_stage/app/main.py", 31),
        (
            TestAsset("src"),
        ...
        (TestAsset("src"), TestAsset("src/main.py"), "/mnt/job_stage/app/main.py", 31),
        (TestAsset("src"), TestAsset("src/subdir/sub_main.py"), "/mnt/job_stage/app/subdir/sub_main.py", 31),
    ...
    @parameterized.parameters(  # type: ignore[misc]
        ...
        (TestAsset("src"), f"@{_TEST_STAGE}/main.py", None, "/mnt/job_stage/app/main.py", 31),
        (TestAsset("src"), f"@{_TEST_STAGE}/", f"@{_TEST_STAGE}/main.py", "/mnt/job_stage/app/main.py", 31),
        (
            TestAsset("src"),
            f"@{_TEST_STAGE}/",
