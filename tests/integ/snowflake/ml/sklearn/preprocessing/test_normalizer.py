...
from snowflake.ml.sklearn.preprocessing import Normalizer  # type: ignore[attr-defined]
...
class NormalizerTest(parameterized.TestCase):
    ...
    def test_serde(self) -> None:
        ...
        importlib.reload(sys.modules["snowflake.ml.sklearn.preprocessing.normalizer"])
