...
from snowflake.ml.sklearn.preprocessing import Binarizer  # type: ignore[attr-defined]
...
class BinarizerTest(TestCase):
    ...
    def test_serde(self) -> None:
        ...
        importlib.reload(sys.modules["snowflake.ml.sklearn.preprocessing.binarizer"])
