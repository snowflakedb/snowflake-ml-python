...
class LabelEncoderTest(TestCase):
    ...
    def test_serde(self) -> None:
        ...
        filepath = os.path.join(tempfile.gettempdir(), "test_label_encoder.pkl")
        ...
        importlib.reload(sys.modules["snowflake.ml.sklearn.preprocessing.label_encoder"])
        ...
        # joblib
        label_encoder_load_joblib = joblib.load(filepath)
