...
class F1ScoreTest(parameterized.TestCase):
    ...
    def test_f1_score_labels(self, params: Dict[str, Any]) -> None:
    ...
    def test_f1_score_pos_label(self, params: Dict[str, Any]) -> None:
        pandas_df = pd.DataFrame(_MULTICLASS_DATA, columns=_SCHEMA)
        input_df = self._session.create_dataframe(pandas_df)
    ...
    def test_f1_score_average_multiclass(self, params: Dict[str, Any]) -> None:
        pandas_df = pd.DataFrame(_MULTICLASS_DATA, columns=_SCHEMA)
        input_df = self._session.create_dataframe(pandas_df)
    ...
    def test_f1_score_average_binary(self, params: Dict[str, Any]) -> None:
    ...
    def test_f1_score_sample_weight(self, params: Dict[str, Any]) -> None:
    ...
    def test_f1_score_zero_division(self, params: Dict[str, Any]) -> None:
        data = [
            [0, 0, 0, 0, 0, 0],
        ]
        pandas_df = pd.DataFrame(data, columns=_SCHEMA)
