...
class MeanAbsolutePercentageErrorTest(parameterized.TestCase):
    """Test mean absolute percentage error (MAPE) regression loss."""
    ...
    def test_sample_weight(self, params: Dict[str, Any]) -> None:
        for values in params["values"]:
            ...
            for sample_weight_col_name in params["sample_weight_col_name"]:
                ...
                sklearn_loss = sklearn_metrics.mean_absolute_percentage_error(
                    pandas_df[y_true],
                    pandas_df[y_pred],
