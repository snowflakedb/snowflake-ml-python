...
class FbetaScoreTest(parameterized.TestCase):
    ...
    def test_fbeta_score_beta(self, params: Dict[str, Any]) -> None:
    ...
    def test_fbeta_score_labels(self, params: Dict[str, Any]) -> None:
    ...
    def test_fbeta_score_pos_label(self, params: Dict[str, Any]) -> None:
        pandas_df = pd.DataFrame(_MULTICLASS_DATA, columns=_SCHEMA)
        input_df = self._session.create_dataframe(pandas_df)
    ...
    def test_fbeta_score_average_multiclass(self, params: Dict[str, Any]) -> None:
        pandas_df = pd.DataFrame(_MULTICLASS_DATA, columns=_SCHEMA)
        input_df = self._session.create_dataframe(pandas_df)
    ...
    def test_fbeta_score_average_binary(self, params: Dict[str, Any]) -> None:
    ...
    def test_fbeta_score_sample_weight(self, params: Dict[str, Any]) -> None:
        for values in params["values"]:
            data = values["data"]
            y_true = values["y_true"]
            y_pred = values["y_pred"]
    ...
    def test_fbeta_score_zero_division(self, params: Dict[str, Any]) -> None:
        data = [
            [0, 0, 0, 0, 0, 0],
        ]
        pandas_df = pd.DataFrame(data, columns=_SCHEMA)
