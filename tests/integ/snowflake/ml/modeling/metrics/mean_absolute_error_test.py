...
class MeanAbsoluteErrorTest(parameterized.TestCase):
    """Test mean absolute error regression loss."""
    ...
    def test_sample_weight(self, params: Dict[str, Any]) -> None:
        for values in params["values"]:
            ...
            for sample_weight_col_name in params["sample_weight_col_name"]:
                actual_loss = snowml_metrics.mean_absolute_error(
                    df=input_df,
                ...
                sklearn_loss = sklearn_metrics.mean_absolute_error(
                    pandas_df[y_true],
                    pandas_df[y_pred],
