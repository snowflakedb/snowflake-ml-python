...
class RocAucScoreTest(parameterized.TestCase):
    ...
    def test_roc_auc_score_average_binary(self, params: Dict[str, Any]) -> None:
    ...
    def test_roc_auc_score_average_multiclass(self, params: Dict[str, Any]) -> None:
    ...
    def test_roc_auc_score_sample_weight(self, params: Dict[str, Any]) -> None:
    ...
    def test_roc_auc_score_max_fpr(self, params: Dict[str, Any]) -> None:
        pandas_df = pd.DataFrame(_BINARY_DATA, columns=_SCHEMA)
        input_df = self._session.create_dataframe(pandas_df)
    ...
    def test_roc_auc_score_multi_class(self, params: Dict[str, Any]) -> None:
        pandas_df = pd.DataFrame(_MULTICLASS_DATA, columns=_SCHEMA)
        input_df = self._session.create_dataframe(pandas_df)
    ...
    def test_roc_auc_score_labels(self, params: Dict[str, Any]) -> None:
        pandas_df = pd.DataFrame(_MULTICLASS_DATA, columns=_SCHEMA)
        input_df = self._session.create_dataframe(pandas_df)
    ...
    def test_roc_auc_score_multilabel(self) -> None:
