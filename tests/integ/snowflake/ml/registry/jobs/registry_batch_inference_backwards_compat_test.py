...
class TestBatchInferenceBackwardsCompatNoParams(registry_batch_inference_test_base.RegistryBatchInferenceTestBase):
...
class TestBatchInferenceBackwardsCompatWithParams(registry_batch_inference_test_base.RegistryBatchInferenceTestBase):
