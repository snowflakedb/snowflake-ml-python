...
class TestBatchInferenceCustomModelWithParamsInteg(registry_batch_inference_test_base.RegistryBatchInferenceTestBase):
    ...
    def _run_params_test(self, input_spec_params: dict[str, Any] | None, model_call_params: dict[str, Any]) -> None:
    ...
    def test_all_default_params(self) -> None:
        """All parameters use their default values (no overrides in Input)."""
    ...
    def test_all_overwritten_params(self) -> None:
        """All parameters overwritten via Input."""
        # bytes_param is disabled: overriding a BYTES-typed param fails in the container with
        # "ValueError: non-hexadecimal number found in fromhex()". Re-enable once SNOW-3729421 is fixed.
        override_params = {
    ...
    def test_mixed_params(self) -> None:
        """Some parameters using defaults and some overwritten."""
        override_params = {
            "int8_param": _OVERRIDE_INT8,
            "uint16_param": _OVERRIDE_UINT16,
            "float_param": _OVERRIDE_FLOAT,
            "bool_param": _OVERRIDE_BOOL,
            "string_param": _OVERRIDE_STRING,
            # bytes_param disabled pending SNOW-3729421; see test_all_overwritten_params.
            # "bytes_param": _OVERRIDE_BYTES,
            "weights_param": _OVERRIDE_WEIGHTS,
        }
        self._run_params_test(
...
class TestBatchInferenceDictParamsInteg(registry_batch_inference_test_base.RegistryBatchInferenceTestBase):
    ...
    def _run_dict_params_test(
        self, input_spec_params: dict[str, Any] | None, model_call_params: dict[str, Any]
    ) -> None:
    ...
    def test_dict_params_defaults(self) -> None:
        """All dict param defaults (no override)."""
    ...
    def test_dict_params_partial_override_deep_merge(self) -> None:
        """Partial dict override triggers deep merge (unspecified keys keep defaults)."""
        self._run_dict_params_test(
    ...
    def test_dict_params_with_scalar_override(self) -> None:
        """Override both scalar and dict params together."""
        self._run_dict_params_test(
