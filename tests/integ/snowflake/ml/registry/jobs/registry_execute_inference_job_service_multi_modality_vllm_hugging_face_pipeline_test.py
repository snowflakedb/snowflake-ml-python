...
class TestExecuteInferenceJobServiceMultiModalityVLLMHuggingFacePipelineInteg(
    ...
    def test_audio_with_vllm(self) -> None:
        ...
        output_validator = registry_execute_inference_job_service_test_base.create_openai_chat_completion_output_validator(  # noqa: E501
    ...
    def test_image_and_video_with_vllm_multi_replica(self) -> None:
        ...
        self._test_registry_execute_inference_job_service(
            ...
            X=input_df,
            output_spec=batch_inference_specs.Output(stage_location=output_stage_location),
            resources_spec=batch_inference_specs.Resources(gpu_requests="1", memory_requests="16Gi"),
            job_name=job_name,
            replicas=3,
            options={"cuda_version": "12.4"},
            signatures=OPENAI_CHAT_SIGNATURE,
