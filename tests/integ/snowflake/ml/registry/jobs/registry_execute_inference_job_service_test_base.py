...
class ExecuteInferenceJobServiceTestBase(registry_spcs_test_base.RegistrySPCSTestBase):
    ...
    def _test_registry_execute_inference_job_service(
        self,
        ...
        *,
        ...
        return self._deploy_execute_inference_job_service(
            mv,
            X=X,
