...
class TestBatchInferenceTaskV2VllmInteg(registry_batch_inference_test_base.RegistryBatchInferenceTestBase):
    """Test the V2 BatchInferenceTask with the vLLM inference engine."""
