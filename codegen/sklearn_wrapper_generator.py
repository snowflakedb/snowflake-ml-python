...
class WrapperGeneratorBase:
    ...
    def __init__(self, module_name: str, class_object: Tuple[str, type]) -> None:
        ...
        self.test_snowpandas_imports = ""
        self.test_snowpandas_imports_list: List[str] = []
...
label_cols: Optional[Union[str, List[str]]]
    ...
    def _populate_file_paths(self) -> None:
        ...
        self.snowpandas_test_file_name = os.path.join(
            "/".join(snow_ml_module_name.split(".")),
            inflection.underscore(self.original_class_name) + "_snowpandas_test.py",
        )
    ...
    def _populate_integ_test_fields(self) -> None:
        ...
        self.test_snowpandas_imports_list = self.test_estimator_imports_list.copy()
        self.test_snowpandas_imports_list.remove(snow_ml_class_import)
    ...
    def _construct_string_from_lists(self) -> None:
        ...
        self.test_snowpandas_imports = "\n".join(self.test_snowpandas_imports_list)
