...
class GenMode(Enum):
    SRC = "SRC"
    TEST = "TEST"
    SNOWPANDAS_TEST = "SNOWPANDAS_TEST"
...
class AutogenTool:
    ...
    Args:
        gen_mode: Possible values {GenMode.SRC, GenMode.TEST, GenMode.SNOWPANDAS_TEST}. Tool generates source code for
            estimator wrappers or integration tests for generated estimator wrappers or snowpandas based on the selected
            mode.
    ...
    def _generate_test_files(
        ...
        """Autogenerate integ tests for snowflake estimator wrappers or snowpandas for the given SKLearn or XGBoost
        module.
        ...
        for generator in generators:
            if self.gen_mode == GenMode.TEST:
                ...
                test_output_file_name = os.path.join(self.output_path, generator.snowpandas_test_file_name)
