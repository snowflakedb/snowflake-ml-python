...
class AutogenTool:
    ...
    Args:
        gen_mode: Possible values {GenMode.SRC, GenMode.TEST}. Tool generates source code
            for estimator wrappers or integration tests for generated estimator wrappers based on the
            selected mode.
